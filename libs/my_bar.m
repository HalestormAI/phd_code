...
%   $Revision: 5.34.6.25 $  $Date: 2011/04/04 22:58:57 $

% First we check which HG plotting API should be used.
if ishg2parent( varargin{:} )
    [v6, cax, args] = parseplotapi(varargin{:},'-mfilename',mfilename);
    h = barHGUsingMATLABClasses(cax, args{:});
else
    % Need to determine if 1st arg is 'v6' flag!
