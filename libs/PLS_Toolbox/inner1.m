...
%  n=# of sigmoids, b=pls linear estimate, t,u score vectors. This routine
%  is used after model structure has been determined. The vector x 
%  contains the optimized weights, and f0 is optimized function value.
