function Answer=timedinputdlg(Prompt, Title, NumLines, DefAns, Resize)
...
if nargin==5 && isstruct(Resize)
  ...
  if isfield(Options,'TimeOut'), TimeOut = Options.TimeOut; end
end
...
if ishghandle(InputFig)
  Answer=DefAns{1};
  if strcmp(get(InputFig,'UserData'),'OK') || TIMEDOUT,
