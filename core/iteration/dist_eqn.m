...
out = d ^ 2 / (nx * x1 + ny * y1 + nz) ^ 2 * x1 ^ 2 - 2 * d ^ 2 / (nx * x1 + ny * y1 + nz) * x1 / (nx * x2 + ny * y2 + nz) * x2 + d ^ 2 / (nx * x2 + ny * y2 + nz) ^ 2 * x2 ^ 2 + d ^ 2 / (nx * x1 + ny * y1 + nz) ^ 2 * y1 ^ 2 - 2 * d ^ 2 / (nx * x1 + ny * y1 + nz) * y1 / (nx * x2 + ny * y2 + nz) * y2 + d ^ 2 / (nx * x2 + ny * y2 + nz) ^ 2 * y2 ^ 2 + d ^ 2 / (nx * x1 + ny * y1 + nz) ^ 2 - 2 * d ^ 2 / (nx * x1 + ny * y1 + nz) / (nx * x2 + ny * y2 + nz) + d ^ 2 / (nx * x2 + ny * y2 + nz) ^ 2 - 1 ^ 2;
